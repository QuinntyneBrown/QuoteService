...
const template = require("./location-item-embed.component.html");
const styles = require("./location-item-embed.component.scss");

export class LocationItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new LocationDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new LocationEdit(this.entity));
    }
...
customElements.define(`ce-location-item-embed`,LocationItemEmbedComponent);

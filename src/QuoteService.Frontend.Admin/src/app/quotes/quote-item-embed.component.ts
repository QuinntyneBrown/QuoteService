...
const template = require("./quote-item-embed.component.html");
const styles = require("./quote-item-embed.component.scss");

export class QuoteItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new QuoteDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new QuoteEdit(this.entity));
    }
...
customElements.define(`ce-quote-item-embed`,QuoteItemEmbedComponent);
